...
def show_model_info():
    ...
    print("\n🏗️ Architecture:")
    print("   • Depthwise Separable Conv: 3→16 channels")
    print("   • ResNet Layer 1: 16 channels, 3 blocks")
    print("   • ResNet Layer 2: 32 channels, 3 blocks, stride=2")
    print("   • ResNet Layer 3: 64 channels, 3 blocks, stride=2")
    print("   • Global Average Pooling")
    print("   • Linear: 64→10 classes")
    
    print("\n🎯 Supported datasets:")
    print("   • MNIST (28x28, grayscale)")
    print("   • Fashion-MNIST (28x28, grayscale)")
    print("   • CIFAR-10 (32x32, RGB)")
    print("   • Any similar dataset with automatic adaptation")
...
if __name__ == "__main__":
    ...
    print("\n📚 Usage examples:")
    print("   from models import MiniResNet20")
    print("   model = MiniResNet20(num_classes=10)")
    print("   ")
    print("   # Works with any of these:")
    print("   mnist_data = torch.randn(batch, 1, 28, 28)")
    print("   cifar_data = torch.randn(batch, 3, 32, 32)")
    print("   output = model(mnist_data)  # Automatic adaptation!")
